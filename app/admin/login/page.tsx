...
import { Lock, Eye, EyeOff, ShieldCheck, BedDouble, ArrowRight, Key, Smartphone, Mail, AlertCircle, CheckCircle2, RefreshCw } from "lucide-react";
...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#12021E] flex items-center justify-center p-4">
      <div className="bg-white p-8 md:p-10 rounded-3xl shadow-2xl max-w-md w-full space-y-6 relative overflow-hidden border border-purple-900/30">
        
        {/* Paso 1: Formulario de Contraseña Principal */}
        {step === "password" && (
          <>
            <div className="text-center space-y-3">
              <div className="w-16 h-16 bg-[#FAF2FF] text-[#A507FA] rounded-2xl mx-auto flex items-center justify-center border border-purple-200 shadow-inner">
                <Lock size={28} />
              </div>
              <h1 className="text-2xl font-serif font-black text-[#1A1C1C]">Acceso al Panel Admin</h1>
              <p className="text-xs text-gray-400 font-medium">
                Ingresa la contraseña de administración para gestionar La Mega Tienda del Colchón
              </p>
            </div>
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-5">
              <div className="space-y-1.5">
                <label className="text-xs font-bold uppercase tracking-wider text-gray-500 flex items-center gap-1.5">
                  <ShieldCheck size={14} className="text-[#A507FA]" /> Contraseña de Administración
                </label>
                <div className="relative">
                  <input
                    ...
                    name="password"
                    placeholder="••••••••••••"
                    className="w-full p-4 pr-12 border-2 rounded-2xl text-sm font-medium focus:outline-none focus:border-[#A507FA] focus:ring-2 focus:ring-[#A507FA]/20 transition-all"
                    required
                    autoFocus
                  />
                  <button
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#A507FA] text-white py-4 rounded-full font-bold text-sm hover:bg-[#8B00D9] transition-all shadow-lg shadow-[#A507FA]/20 disabled:bg-gray-300 flex items-center justify-center gap-2"
              >
                {loading ? (
          ...
          <div className="space-y-5 animate-in fade-in duration-300">
            ...
            <form onSubmit={handle2FASubmit} className="space-y-4">
              <div className="space-y-1.5">
                <input
                  ...
                  className="w-full p-4 border-2 rounded-2xl text-center font-mono text-2xl font-black tracking-[0.5em] focus:outline-none focus:border-[#A507FA] focus:ring-2 focus:ring-[#A507FA]/20"
                  required
                  autoFocus
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-[#12021E] text-white py-4 rounded-full font-bold text-sm hover:bg-[#A507FA] transition-all shadow-md disabled:bg-gray-300 flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-3 border-t text-center space-y-2">
              <button
                ...
                className="text-xs text-[#A507FA] font-bold hover:underline flex items-center justify-center gap-1.5 mx-auto"
              >
                <Mail size={14} />
          ...
          <div className="space-y-5 animate-in fade-in duration-300">
            ...
            <form onSubmit={handleRescueSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <input
                  ...
                  placeholder="0 0 0 0 0 0"
                  className="w-full p-4 border-2 border-purple-300 rounded-2xl text-center font-mono text-2xl font-black tracking-[0.5em] focus:outline-none focus:border-[#A507FA]"
                  required
                  autoFocus
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-[#A507FA] text-white py-4 rounded-full font-bold text-sm hover:bg-[#8B00D9] transition-all shadow-md disabled:bg-gray-300 flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-2 text-center flex justify-between items-center text-xs">
              <button
                ...
                onClick={handleRequestRescueEmail}
                disabled={sendingRescue}
                className="text-gray-500 font-bold hover:text-[#A507FA] flex items-center gap-1"
              >
        ...
        <div className="pt-4 border-t text-center">
          <a
            href="/"
            className="text-xs font-bold text-gray-400 hover:text-[#A507FA] transition-colors flex items-center justify-center gap-1.5"
          >
            <BedDouble size={14} /> Volver a la Tienda Pública
          </a>
        </div>
      </div>
    </div>
